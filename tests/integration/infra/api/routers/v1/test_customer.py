...
async def test_get_customer_not_found(async_test_client, customer_route):
...
async def test_get_customer_invalid_id(async_test_client, customer_route):
    async with async_test_client as client:
...
async def test_create_customer_persistence(
    async_test_client, customer_route, create_customer_payload
):
    async with async_test_client as client:
...
async def test_create_customer_conflict(
    async_test_client, customer_route, create_customer_payload
):
    async with async_test_client as client:
...
async def test_delete_customer_not_found(async_test_client, customer_route):
    async with async_test_client as client:
...
async def test_delete_customer_successfully(
    async_test_client, customer_route, create_customer_payload
):
    async with async_test_client as client:
